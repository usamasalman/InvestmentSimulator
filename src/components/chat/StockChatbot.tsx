...
export const StockChatbot = ({ stockContext }: StockChatbotProps) => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "👋 Hello! I'm your AI Stock Advisor for the Tadawul market. Ask me anything about Saudi stocks, sectors, investment strategies, or specific companies. How can I help you today?",
    },
  ]);
